...
class LifeStylePlusKYC extends StatefulWidget {
  const LifeStylePlusKYC({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          const DocumentsPoints(text: 'Please upload the front page of the ID card'),
          const DocumentsPoints(text:'Ensure that the ID card is completely visible, the font is clear, and the brightness is uniform'),
          const DocumentsPoints(text:'The photo should be less than 2MB and can be in jpg/jpeg/png formats'),
          const SizedBox(
            height: 20,
          ),
          const HeadingText(
          ...
          const DocumentsPoints(text:'Please upload your selfie with hand holding the ID card'),
          const DocumentsPoints(text:'Take a selfie with hand holding the ID card information page'),
          const SizedBox(
            height: 20,
          ),
          const HeadingText(
          ...
          const DocumentsPoints(text:'The photo of the signature must be clearly visible'),
          const DocumentsPoints(text:'The photo should be less than 1MB and can be in jpg/jpeg/png formats'),
          const SizedBox(
            height: 30,
          ),
          InputField(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text(text,style: const TextStyle(fontFamily: AppTheme.fontRegular,fontSize: 14,color: Colors.white),)
            ],
          ),
        ),
