    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          const DocumentsPoints(text:"We don't charge any fee for the linking service"),
          const DocumentsPoints(text:'Please fill all the details carefully'),
          const DocumentsPoints(text:'Once the card is linked, you will not be able to unlink the card'),
          const SizedBox(
            height: 20,
          ),
          ButtonPrimary(
