...
Future<void> encryptData(data) async {
  final publicKey = await parseKeyFromFile<RSAPublicKey>('assets/pem/public_key.pem');
  final privKey = await parseKeyFromFile<RSAPrivateKey>('assets/pem/private_key.pem');
